...
public class ConfigView extends JFrame {
	...
	public ConfigView() {
		...
		lblWurzelverzeichnis = new JLabel("Wurzelverzeichnis ");
		...
		// Leerzeilen
		lblLeerzeilen = new JLabel("Beachte Leerzeilen ");
		...
		// Satzzeichen
		lblSatzzeichen = new JLabel("Beachte Satzzeichen ");
		...
		// Grossschreibung
		lblGrossschreibung = new JLabel("Beachte Großschreibung ");
		...
		// Linematch
		lblLinematch = new JLabel("Zeilenweiser Vergleich");
		...
		// Sortierte Elemente
		lblSortiereElemente = new JLabel("Sortiere Elemente");
		...
		// Sortierte Attribute
		lblSortiereAttribute = new JLabel("Sortiere Attribute");
		...
		// Loesche Attribute
		lblLoescheAttribute = new JLabel("Lösche Attribute");
		...
		// Lösche Kommentare
		lblLoescheKommentare = new JLabel("Lösche Kommentare");
		...
		// Nur Tags
		lblNurTags = new JLabel("Nur Tags");
