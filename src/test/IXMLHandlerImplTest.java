...
public class IXMLHandlerImplTest {
	...
	public void test_sortAttributes() {
		iXML.clearErrorList();
		try {
			testdateiDoc = builder
					.build(new File(
							System.getProperty("user.dir")
									+ File.separator
									+ "/src/test/testFiles/XMLTestFiles/TestFileSortAttributes.xml"));
		} catch (Exception e) {
			System.out
					.println("Fehler in beforeAllTests: Testdateien beschaedigt!");
			e.printStackTrace();
		}

		try {
			erwartetesErgebnissDoc = builder
					.build(new File(
							System.getProperty("user.dir")
									+ File.separator
									+ "/src/test/testFiles/XMLTestFiles/ExpectedOutcome/ExpectedOutcomeSortAttributes.xml"));
		} catch (Exception e) {
			System.out
					.println("Fehler in beforeAllTests: Testdateien beschaedigt!");
			e.printStackTrace();
		...
		try {
			testdateiDoc = builder
					.build(new File(
							System.getProperty("user.dir")
									+ File.separator
									+ "/src/test/testFiles/XMLTestFiles/TestFileSortElements.xml"));
		} catch (Exception e) {
			System.out
					.println("Fehler in beforeAllTests: Testdateien beschaedigt!");
			e.printStackTrace();
		...
		try {
			erwartetesErgebnissDoc = builder
					.build(new File(
							System.getProperty("user.dir")
									+ File.separator
									+ "/src/test/testFiles/XMLTestFiles/ExpectedOutcome/ExpectedOutcomeSortElements.xml"));
		} catch (Exception e) {
			System.out
					.println("Fehler in beforeAllTests: Kontrolldateien beschaedigt!");
			e.printStackTrace();
		}

		String ist = xout.outputString(iXML.sortElements(testdateiDoc,
				new IXMLElementComparator()));
		String soll = xout.outputString(erwartetesErgebnissDoc);
		...
		try {
			erwartetesErgebnissDoc = builder
					.build(new File(
							System.getProperty("user.dir")
									+ File.separator
									+ "/src/test/testFiles/XMLTestFiles/ExpectedOutcome/ExpectedOutcomeDeleteComments.xml"));
		} catch (Exception e) {
			System.out
					.println("Fehler in beforeAllTests: Kontrolldateien beschaedigt!");
			e.printStackTrace();
		...
		try {
			erwartetesErgebnissDoc = builder
					.build(new File(
							System.getProperty("user.dir")
									+ File.separator
									+ "/src/test/testFiles/XMLTestFiles/ExpectedOutcome/ExpectedOutcomeDeleteAttributes.xml"));
		} catch (Exception e) {
			System.out
					.println("Fehler in beforeAllTests: Kontrolldateien beschaedigt!");
			e.printStackTrace();
	...
	public void test_tagsOnly() {
		...
		try {
			erwartetesErgebniss = new File(
					System.getProperty("user.dir")
							+ File.separator
							+ "/src/test/testFiles/XMLTestFiles/ExpectedOutcome/ExpectedOutcomeTagsOnly.xml");
	...
	public void test_parseFile_NoValidation_Successful() {
		...
		assertFalse(iXML.parseFile(testdatei, 0, null));
	...
	public void test_parseFile_NoValidation_unsuccessful() {
		...
		try {
			testdatei = new File(System.getProperty("user.dir")
					+ File.separator
					+ "/src/test/testFiles/XMLTestFiles/TestFileFaultyXML.xml");
		...
		assertTrue(iXML.parseFile(testdatei, 0, null));
	...
	/*
	 * Für diesen Testfall muss die Referenz im XML File an das Benutzer
	 * Verzeichniss angepasst werden *
	 */
	@Test
	public void test_parseFile_Validation_XSDinternal_successful() {
		...
		try {
			testdatei = new File(
					System.getProperty("user.dir")
							+ File.separator
							+ "/src/test/testFiles/XMLTestFiles/TestFileInternalXSD.xml");
		...
		assertFalse(iXML.parseFile(testdatei, 1, null));
		List<IParseError> errorListe = iXML.getErrorList();
	...
	public void test_parseFile_Validation_XSDinternal_unsuccessful() {
		...
		assertTrue(iXML.parseFile(testdatei, 1, null));
		List<IParseError> errorListe = iXML.getErrorList();
	...
	public void test_parseFile_Validation_dtd_successful() {
		...
		try {
			testdatei = new File(System.getProperty("user.dir")
					+ File.separator
					+ "/src/test/testFiles/XMLTestFiles/TestFileDTD.xml");
		...
		assertFalse(iXML.parseFile(testdatei, 2, null));
		List<IParseError> errorListe = iXML.getErrorList();
	...
	public void test_parseFile_Validation_dtd_unsuccessful() {
		...
		try {
			testdatei = new File(System.getProperty("user.dir")
					+ File.separator
					+ "/src/test/testFiles/XMLTestFiles/TestFileDTDFaulty.xml");
		...
		assertTrue(iXML.parseFile(testdatei, 2, null));
		List<IParseError> errorListe = iXML.getErrorList();
	...
	public void test_parseFile_ExternalXSD_Successful() {
		...
		try {
			testdatei = new File(
					System.getProperty("user.dir")
							+ File.separator
							+ "/src/test/testFiles/XMLTestFiles/TestFileExternalXSD.xml");
		...
		File xsdfile = new File(System.getProperty("user.dir") + File.separator
				+ "/src/test/testFiles/XMLTestFiles/TestFileExternalXSD.xsd");
		assertFalse(iXML.parseFile(testdatei, 3, xsdfile));
		List<IParseError> errorListe = iXML.getErrorList();
	...
	public void test_parseFile_ExternalXSD_Unsuccessful() {
		...
		File xsdfile = new File(System.getProperty("user.dir") + File.separator
				+ "/src/test/testFiles/XMLTestFiles/TestFileExternalXSD.xsd");
		assertTrue(iXML.parseFile(testdatei, 3, xsdfile));
	...
	public void test_xmlPrepare_Correct() {
		...
		try {
			testMap1 = new File(System.getProperty("user.dir") + File.separator
					+ "/src/test/testFiles/XMLTestFiles/TestFileMap1.xml");

			testMap2 = new File(System.getProperty("user.dir") + File.separator
					+ "/src/test/testFiles/XMLTestFiles/TestFileMap2.xml");

			/*
			 * In testMap2 soll zu Anfang das gleiche stehen wie in testMap1 und
			 * muss zu jedem neustart der Testfälle erneut kopiert werden
			 */
	...
	public void test_xmlPrepare_Incorrect() {
		...
		try {
			testMap3 = new File(System.getProperty("user.dir") + File.separator
					+ "/src/test/testFiles/XMLTestFiles/TestFileMap3.xml");

			testMap4 = new File(System.getProperty("user.dir") + File.separator
					+ "/src/test/testFiles/XMLTestFiles/TestFileMap4.xml");
